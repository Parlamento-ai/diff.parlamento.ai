...
<section>
	<h2 class="text-lg font-heading font-bold text-gray-900 mb-4">Boletines en Tramitacion</h2>

	{#if bills.length === 0}
		<p class="text-sm text-gray-500">No hay boletines en tramitacion.</p>
	{:else}
		<div class="space-y-3">
			{#each bills as bill}
